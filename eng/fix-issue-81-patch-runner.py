...
# Strengthen the generated source-contract test to require private-cache isolation and an explicitly deferred read transaction.
...
print('Issue #81 patch runner hardened for private-cache explicitly deferred snapshot reads.')
